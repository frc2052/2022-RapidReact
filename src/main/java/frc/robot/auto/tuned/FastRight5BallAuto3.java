...
public class FastRight5BallAuto3 extends AutoBase {
     ...
     * @param climber
     */
    public FastRight5BallAuto3(SwerveDriveSubsystem drivetrain, VisionSubsystem vision, ShooterSubsystem shooter, IntakeSubsystem intake, IndexerSubsystem indexer, HopperSubsystem hopper, HookClimberSubsystem climber) {
