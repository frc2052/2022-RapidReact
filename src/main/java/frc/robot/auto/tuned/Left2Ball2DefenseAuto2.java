...
public class Left2Ball2DefenseAuto2 extends AutoBase {
     ...
     * @param climber
     */
    public Left2Ball2DefenseAuto2(SwerveDriveSubsystem drivetrain, VisionSubsystem vision, ShooterSubsystem shooter, IntakeSubsystem intake, IndexerSubsystem indexer, HopperSubsystem hopper, HookClimberSubsystem climber) {
