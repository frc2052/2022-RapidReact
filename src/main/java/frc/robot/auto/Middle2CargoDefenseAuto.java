...
public class Middle2CargoDefenseAuto extends AutoBase {
    ...
    public Middle2CargoDefenseAuto(DrivetrainSubsystem drivetrain, VisionSubsystem vision) {
        ...
        SwerveControllerCommand driveToleftmostBallPos = super.createSwerveTrajectoryCommand(super.m_slowTrajectoryConfig, super.getLastEndingPosCreated(Rotation2d.fromDegrees(110)), leftmostBallPos, aim);
        SwerveControllerCommand driveToOpposingBallPos = super.createSwerveTrajectoryCommand(super.m_slowTrajectoryConfig, super.getLastEndingPosCreated(Rotation2d.fromDegrees(135)), opposingBallPos, aimAtOpposingBall);
        SwerveControllerCommand driveAwayCommand = super.createSwerveTrajectoryCommand(m_fastTrajectoryConfig, super.getLastEndingPosCreated(), driveAway, aimAtHub);
