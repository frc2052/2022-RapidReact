...
public class MiddleDefenseAuto extends AutoBase {
    public MiddleDefenseAuto(DrivetrainSubsystem drivetrain, VisionSubsystem vision) {
        super(drivetrain);
        ...
        SwerveControllerCommand driveToFirstBallPos = super.createSwerveTrajectoryCommand(super.m_slowTrajectoryConfig, startPos, firstBallPos, aimNeg90);
        SwerveControllerCommand driveToOpponentBallPos = super.createSwerveTrajectoryCommand(super.m_slowTrajectoryConfig, firstBallPos, opponentBallPos, aimNeg120);
