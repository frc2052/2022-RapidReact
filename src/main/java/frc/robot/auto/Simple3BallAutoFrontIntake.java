...
public class Simple3BallAutoFrontIntake extends AutoBase {
    public Simple3BallAutoFrontIntake(DrivetrainSubsystem drivetrain, VisionSubsystem vision) {
        ...
        VisionTurnInPlaceCommand autoAim1 = new VisionTurnInPlaceCommand(drivetrain, vision);
        ...
        Supplier<Rotation2d> rotate180 = () -> { return Rotation2d.fromDegrees(160); };
        ...
        this.addCommands(new TurnInPlaceCommand(drivetrain, Rotation2d.fromDegrees(160)));
