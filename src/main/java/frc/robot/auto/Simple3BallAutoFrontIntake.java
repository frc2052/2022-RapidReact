...
public class Simple3BallAutoFrontIntake extends AutoBase {
    ...
    private Rotation2d visionRotation;
    ...
    public Simple3BallAutoFrontIntake(DrivetrainSubsystem drivetrain, VisionSubsystem vision) {
        ...
        */
        ...
        SwerveControllerCommand aimWhileDriving = super.ceateSwerveTrajectoryCommand(super.m_slowTrajectoryConfig, startPos2, shootAndDriveRotate, trackTargetToEnd);
        ...
        this.addCommands(aimWhileDriving);
