...
public class CISSimple3Ball extends AutoBase {
     ...
     * @param climber
     */
    public CISSimple3Ball(DrivetrainSubsystem drivetrain) {
        ...
        AutoTrajectoryConfig path2Config = super.createTrajectoryConfig(3, 3, 1, 5, 2);
