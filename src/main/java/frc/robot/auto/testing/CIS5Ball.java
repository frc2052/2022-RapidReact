...
public class CIS5Ball extends AutoBase {
    /**
     ...
     * @param climber
     */
    public CIS5Ball(DrivetrainSubsystem drivetrain) {
        ...
        // Slowed down speed values because we suspect your neos (which are worse in every way apparently) cant handle the original lol
        AutoTrajectoryConfig intakeBall1TrajectoryConfig = super.createTrajectoryConfig(2.5, 2, 1, 5, 3);
        AutoTrajectoryConfig intakeBall2TrajectoryConfig = super.createTrajectoryConfig(3, 3, 2, 5, 2);
        AutoTrajectoryConfig toTerminalTrajectoryConfig = super.createTrajectoryConfig(3, 3, 3, 5, 3);
        AutoTrajectoryConfig realignTrajectoryConfig = super.createTrajectoryConfig(2.5, 2, 2, 5, 2);
        AutoTrajectoryConfig backToShootTrajectoryConfig = super.createTrajectoryConfig(3, 4, 2, 6, 2);
