...
public class Right4BallCoOpAuto extends AutoBase {
    /**
     ...
     * @param climber
     */
    public Right4BallCoOpAuto(SwerveDriveSubsystem drivetrain, VisionSubsystem vision, ShooterSubsystem shooter, IntakeSubsystem intake, IndexerSubsystem indexer, HopperSubsystem hopper, HookClimberSubsystem climber) {
        ...
        Pose2d shootPos = super.newPose2dInches(0, 220, 45);
