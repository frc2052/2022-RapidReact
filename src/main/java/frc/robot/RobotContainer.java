...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
    ...
    switch (dashboardControlsSubsystem.getSelectedAuto()) {
      case AUTO_TESTING:
        return new AutoTesting(drivetrainSubsystem, visionSubsystem, intakeSubsystem, hopperSubsystem);
      case TEST_AUTO_1:
      ...
      case LEFT_2_BALL_1_DEFENSE:
        return new LeftDefenseAuto(drivetrainSubsystem, visionSubsystem, shooterSubsystem, intakeSubsystem,
      ...
      case MIDDLE_TERMINAL_DEFENSE:
        return new MiddleLeftTerminalDefenseAuto(drivetrainSubsystem, visionSubsystem, shooterSubsystem,
            intakeSubsystem, indexerSubsystem, hopperSubsystem);
      case FIVE_BALL:
        return new RightFiveBallAuto(drivetrainSubsystem, visionSubsystem, shooterSubsystem, intakeSubsystem,
            indexerSubsystem, hopperSubsystem);
      case RIGHT_MIDDLE_5_BALL_1_DEFENSE:
        return new MiddleRight5BallDefenseAuto(drivetrainSubsystem, visionSubsystem, shooterSubsystem, intakeSubsystem,
            indexerSubsystem, hopperSubsystem);
      default:
        break;
    }
