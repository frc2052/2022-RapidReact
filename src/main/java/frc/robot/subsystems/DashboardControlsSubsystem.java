...
public class DashboardControlsSubsystem extends SubsystemBase {
    ...
    private DashboardControlsSubsystem(RobotContainer robotContainer) { //VisionSubsystem vision, RobotContainer robotContainer, ShooterSubsystem shooter) { // Adds values and items to selectors and toggles. Currently don't like passing robot container but might need to...
        // this.vision = vision;
    ...
    public static void init(RobotContainer robotContainer) {
        if (instance == null) {
            instance = new DashboardControlsSubsystem(robotContainer);
        }
    }
    ...
    public enum Autos {
        ...
        CIS_TEST_ONE_BALL("*TUNED* One Ball", "Any Starting Location Facing Towards Hub"),
        CIS_TEST_BASIC_ONE_BALL("*TUNED* One Ball", "Any Starting Location Facing Towards Hub"),
        CIS_SIMPLE_3_BALL("*TUNED* Simple 3 Ball", "Far Right Start (A) Facing Towards Hub"),
        CIS_FAST_RIGHT_FIVE_BALL_4("*TUNED* Right Five Ball Auto 4 - Faster", "Far Right Start (A2) Facing Towards From Hub"),
