...
public class PixyCamSubsystemOld extends SubsystemBase {
  ...
  public PixyCamSubsystemOld() {
    try {
      port = new I2C(I2C.Port.kOnboard, PIXY_ADDRESS);
    } catch (Exception e) {
      System.out.println("****************************PIXY ERROR : " + e.getLocalizedMessage());
    }
  }
